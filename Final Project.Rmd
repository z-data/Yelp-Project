...
names(vaxes) = c("state", "Doses_given", "Fully_vaccinated", "Population_fully_vaccinated")
...
```
```{r}
# scaling the total cases between 1 and 0 
covid_cases$Cases = (covid_cases$Cases - min(covid_cases$Cases)) / (max(covid_cases$Cases) - min(covid_cases$Cases))
